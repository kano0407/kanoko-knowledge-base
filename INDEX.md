# 📚 Kanoko VTuber Knowledge Base

このObsidian Vault は、VTuber活動「かのこ」の全知識を統合管理します。

## 🎯 クイックナビゲーション

### 👤 プロフィール
- [[00_Profile/_profile|プロフィール]]
- [[00_Profile/_channel-stats|チャンネル統計]]
- [[00_Profile/_goals|目標・ロードマップ]]

### 📈 戦略・方針
- [[01_Strategy/x-mindset|X運用マインドセット]]
- [[01_Strategy/youtube-shorts-6step|YouTube Shorts 6ステップ戦略]]
...
- **audience-feedback-aggregator**
  - [[03_Skills/audience-feedback-aggregator/SKILL|スキル定義]]
  - [[03_Skills/audience-feedback-aggregator/eval-1-with-skill|Eval 1 with-skill (9.6/10)]]
  - [[03_Skills/audience-feedback-aggregator/eval-2-with-skill|Eval 2 with-skill (9.7/10)]]
  - [[03_Skills/audience-feedback-aggregator/eval-3-with-skill|Eval 3 with-skill (9.7/10)]]

- **platform-analysis-integrator**
  - [[03_Skills/platform-analysis-integrator/SKILL|スキル定義]]
...
- [[04_Analysis/monthly/2026-04-notebooklm-results|NotebookLM分析結果]]

### 📝 コンテンツ資料
- [[05_Content/reference/talk-patterns|VTuberトークパターン分析]]

### 📋 運用・スケジュール
- [[06_Operations/guidelines/behavior|Claude行動ガイドライン]]
- [[06_Operations/department-status/producer|プロデューサー部]]

### 📚 参考資料
- [[07_Reference/notion-pages|Notion構造]]
- [[07_Reference/notebooklm-integration|NotebookLM連携]]

## 🔍 タグで検索

- `#status/in-progress` — 進行中プロジェクト
- `#status/completed` — 完了済み
- `#priority/p1` — 優先度P1（今月）
- `#priority/p2` — 優先度P2（来月）
- `#skill/*` — スキル別検索
- `#evaluation/with-skill` — スキル版評価
- `#project/workflow-c` — Workflow C プロジェクト

## 📊 グラフビュー

Obsidian右側の「グラフ」アイコンをクリックすると、プロジェクト・スキル間の依存関係を可視化できます。

## ℹ️ このVaultについて

- **作成日**: 2026-04-10
- **ステータス**: Phase 1 完成（単方向同期）
- **次フェーズ**: Phase 2（リアルタイム同期スクリプト）
- **ファイル数**: 50+
- **タグ数**: 20
